...
## G1：Assist_SN `0x00230122` 與 Assist_CN `0x00230121` 的完整格式
...
## G2：Death_SN `0x00230124` body 與伺服器目前送法的比對
...
## G3：遊戲內聊天廣播（`0x00220507`／`0x00220509`／`0x00360601`）
...
## G4：建房 Create_CQ `0x00220201` 組語核對，以及地圖／難度怎麼傳
