...
1. **發給朋友之前補一輪「30000 ＋ 人手連按到底」的對照。** 三輪 NETSPEED-MIN 都是自動化的
   3.5 秒間隔，只涵蓋**孤立單發**；第 2 輪的**成串失敗**是靠操作者人手連按才量到的，
   30000 下那個形態**沒測過**。這是目前唯一擋在「把修補發出去」前面的量測。
2. **決定要發哪個值**。技術上 30000 夠；100000 是每條連線上限，8 人房房主上行最壞約 800 KB/s，
   走中繼可能撐不住 —— 這是當初開 NETSPEED-MIN 的理由，現在有答案了。
