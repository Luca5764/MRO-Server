...
| 2026-09-17 | `2026-09-17-23-g6-slot-change-save.md` | `0x00240107`、`0x00240108` | 🟡 待審／預設關閉 | G6：由解密客戶端原始碼確認 7 個 CQ dword 是 item serial；新增交易式 equipped 保存與 SA 回覆，尚待實測與高階審查。 |
