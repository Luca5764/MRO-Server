...
| 2026-09-17 | `2026-09-17-22-pve-mech-slot-selection.md` | `0x00230101`、`0x00230102`、`0x00240111` | 🟡 Claude 已審（抽查）＋實作待測 T | G5：確認 PvE `ZSlotSelectPage` 關閉後經 `Game_Slot` 送 `ChangeSlot_CN` 的 body 與時機；對照 hangar default-slot 路徑、目前 `Game_User_SN` 狀態缺口與跳過選擇頁的實測原因。 |
