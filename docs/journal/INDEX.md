...
| 2026-09-17 | `2026-09-17-12-pve-round-zero.md` | `0x00222111`、`0x00220201` | ✅ [DLL] 欄位；🟡 Create_CQ 順序；待測 N | PvE 回合沒啟動：Game_Info_SN body+0x15 是 MapInfo.Round，我們送 0，`ModeReset_BD` 直接 return；改送建房 body[6]（PlayRound=5）。附 GAME_INFO 完整偏移並更正 2026-09-16-05。 |
