...
| 2026-09-18 | `2026-09-18-06-g6-equip-save-verified.md` | `0x00240107`、`0x00240108`、`0x00210111`、`0x00240241`、`0x00240242` | ✅ Claude 高階審查＋實測 | G6 結案：商店篩選、購入分類、ItemInfo 重送、SerialIndex 保留區四層阻塞依序解除；W3 換裝寫 DB，完全重登後仍保留 `22100301`。PvE 出場武器留 backlog H4。 |
