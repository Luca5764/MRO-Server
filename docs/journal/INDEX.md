...
| 2026-09-18 | `2026-09-18-03-g6d-shop-full-catalog.md` | `0x00240241`、`0x00240242` | 🟡 待審／預設關閉 | G6d：新增 `SHOP_FULL_CATALOG_MODE`；enabled 時送出 category 2..6 完整 catalog、依 item_id 排序並以每分類最多 45 筆分包，disabled 保留原路徑；未實測。 |
