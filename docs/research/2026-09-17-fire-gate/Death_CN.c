// ======== 0x107d98a0  FUN_107d98a0  @ 107d98a0 ========
void __thiscall
FUN_107d98a0(int param_1,int param_2,int param_3,int param_4,undefined4 param_5,Format param_6,
            int param_7)
{
  bool bVar1;
  UObject *pUVar2;
  ...
  if (*(char *)(param_1 + 4) == '\0') {
    ZNetworkManager::Log_Set
              (*(ZNetworkManager **)GZNetworkManager_exref,1,"ZDispatchGame::Death_CN");
  }
  else {
...
LAB_107d99f5:
            pFVar3 = (Format *)thunk_FUN_107d8790();
            *(short *)(pFVar3 + 0x12) = (short)param_2;
            pFVar3[0x15] = (Format)(param_7 != 0);
            *(short *)(pFVar3 + 0x10) = (short)param_4;
            *(undefined4 *)(pFVar3 + 0x17) = param_5;
            pFVar3[0x16] = param_6;
            switch(param_3) {
            case 1:
            ...
            ZNetworkManager::Log_Set
                      (*(ZNetworkManager **)GZNetworkManager_exref,2,"ZDispatchGame::Death_CN");
